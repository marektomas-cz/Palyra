...
pub(crate) const DEFAULT_MAX_SCREENSHOT_BYTES: u64 = 1024 * 1024;
...
pub(crate) const DOWNLOAD_ALLOWED_EXTENSIONS: &[&str] = &[
    ...
    "jsonl", "log", "m4a", "m4v", "map", "markdown", "md", "mjs", "mov", "mp3", "mp4", "mpeg",
    "mpg", "odf", "odp", "ods", "odt", "oga", "ogg", "opus", "otf", "pdf", "png", "ppt", "pptx",
    "rar", "rtf", "svg", "tar", "tbz2", "tgz", "tif", "tiff", "toml", "tsv", "ttf", "txt", "wasm",
    "wav", "webm", "webp", "woff", "woff2", "xls", "xlsx", "xml", "xz", "yaml", "yml", "zip",
    "zst",
];
