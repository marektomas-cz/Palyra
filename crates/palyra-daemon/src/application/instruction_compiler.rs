...
mod tests {
    ...
    fn tool_specific_contract_explains_workspace_patch_grammar() {
        ...
        assert!(contract.contains("under that scoped directory"));
    }
