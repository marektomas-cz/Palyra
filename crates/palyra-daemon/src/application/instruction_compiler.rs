...
mod tests {
    ...
    fn tool_specific_contract_explains_process_runner_limits() {
        ...
        assert!(contract.contains("command='palyra.process.stop'"));
        assert!(contract.contains("cleanup.portable_stop_command"));
        assert!(contract.contains("command='palyra.process.status'"));
