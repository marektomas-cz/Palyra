...
mod tests {
    ...
    fn tool_specific_contract_explains_cross_session_memory() {
        ...
        assert!(contract.contains("defaults to scope=principal"));
        assert!(contract.contains("scope=principal"));
