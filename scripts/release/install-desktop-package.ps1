...
Write-Output "cli_session_path_updated=$($cliExposure.session_path_updated)"
Write-Output "cli_user_path_updated=$($cliExposure.user_path_updated)"
Write-Output "cli_current_shell_command=$($cliExposure.current_shell_command)"
Write-Output "cli_new_shell_command=$($cliExposure.new_shell_command)"
Write-Output "cli_parent_shell_command=$($cliExposure.parent_shell_command)"
Write-Output "cli_parent_shell_path_restart_required=$($cliExposure.parent_shell_path_restart_required)"
Write-Output "cli_parent_shell_note=$($cliExposure.parent_shell_path_note)"
