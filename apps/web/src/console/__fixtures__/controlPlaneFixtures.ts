    ...
    observability: {
      ...
      config_ref_health: {
        ...
        summary: {
          ...
          stale: 1,
          hot_safe_refs: 0,
          restart_required_refs: 1,
          blocked_while_runs_active_refs: 1,
          manual_review_refs: 0,
          blocking_refs: 1,
          warning_refs: 1,
          latest_snapshot_generation: 2,
          latest_snapshot_at_unix_ms: 1700000002500,
          active_runs: 2,
        },
        recommendations: [
          "Set the missing environment variable or migrate this ref to vault.",
          "Wait for active runs to finish, then rerun the reload plan or apply step.",
        ],
        latest_plan: {
          plan_id: "reload-plan-1",
          generated_at_unix_ms: 1700000002600,
          active_runs: 2,
          ...
          steps: [
            {
              ...
              config_path: "model_provider",
              category: "blocked_while_runs_active",
              reason: "provider credentials changed while runs are active",
            },
          ],
        },
        items: [
          {
            ref_id: "model_provider.openai_api_key_secret_ref:fp-openai",
            component: "model_provider",
            config_path: "model_provider.openai_api_key_secret_ref",
            state: "missing",
            severity: "blocking",
            reload_mode: "blocked_while_runs_active",
            advice: "Set the missing environment variable or migrate this ref to vault.",
          },
          {
            ref_id: "admin.auth_token_secret_ref:fp-admin",
